...
public static class Messages
{
    ...
    public static readonly string ProductAdded = "Product Added";
    public static readonly string ProductInvalidName = "Product Invalid Name";
    public static readonly string AuthorizationDenied = "Unauthorized";
